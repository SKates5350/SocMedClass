...
my_oauth = 'EAACEdEose0cBAIipWtrjdGjAmajIz2dmJmDZCbPHj52dIr6oLBViOGuZAJGpN0MBkFOcY4SMrsUFO3ZB3PMYYzRGzPn6pPpGGD3cV5zUdZCBquUS1jZBoozeb3i2BlbmEwEPqTHQDJpgBcOKS8DthfnGleAAErpZBg7dmoEc3mvQZDZD'

## Now try running the following line:
getUsers("me", token=my_oauth, private_info=FALSE)
...
which(page$likes_count == max(page$likes_count))
...
# For example, imagine we want to get all the posts from Nov 2016
page = getPage("humansofnewyork", token=my_oauth, n=1000,
	since='2016/11/01', until='2016/11/31') 
