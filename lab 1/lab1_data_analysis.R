...
## maximum number of likes for a post
max(dataset$likes_count) 

## How can we find out what post received the most likes?
which(dataset$likes_count==838) ## note that here we need to use two equal signs!
## here:
dataset[460,]
